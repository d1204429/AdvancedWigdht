...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        EditText etNmu1 =(EditText)findViewById(R.id.num1);
        num1 = Double.parseDouble(String.valueOf(etNmu1.getText()));
        EditText etNmu2 =(EditText)findViewById(R.id.num2);
        num2 = Double.parseDouble(String.valueOf(etNmu2.getText()));
